...
var (
	pattern_Query_EpochInfos_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"fa-chain", "fachain", "epochs"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_CurrentEpoch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fa-chain", "fachain", "epochs", "current_epoch"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_EpochInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fa-chain", "fachain", "epochs", "epoch_info"}, "", runtime.AssumeColonVerbOpt(false)))
)
