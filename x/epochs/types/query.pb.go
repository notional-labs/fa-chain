...
// source: fachain/epochs/query.proto
...
func (*QueryEpochsInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1ad6d44a5d5d0a05, []int{0}
}
...
func (*QueryEpochsInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1ad6d44a5d5d0a05, []int{1}
}
...
func (*QueryCurrentEpochRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1ad6d44a5d5d0a05, []int{2}
}
...
func (*QueryCurrentEpochResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1ad6d44a5d5d0a05, []int{3}
}
...
func (*QueryEpochInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1ad6d44a5d5d0a05, []int{4}
}
...
func (*QueryEpochInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1ad6d44a5d5d0a05, []int{5}
}
...
func init() {
	proto.RegisterType((*QueryEpochsInfoRequest)(nil), "fachain.epochs.QueryEpochsInfoRequest")
	proto.RegisterType((*QueryEpochsInfoResponse)(nil), "fachain.epochs.QueryEpochsInfoResponse")
	proto.RegisterType((*QueryCurrentEpochRequest)(nil), "fachain.epochs.QueryCurrentEpochRequest")
	proto.RegisterType((*QueryCurrentEpochResponse)(nil), "fachain.epochs.QueryCurrentEpochResponse")
	proto.RegisterType((*QueryEpochInfoRequest)(nil), "fachain.epochs.QueryEpochInfoRequest")
	proto.RegisterType((*QueryEpochInfoResponse)(nil), "fachain.epochs.QueryEpochInfoResponse")
}

func init() { proto.RegisterFile("fachain/epochs/query.proto", fileDescriptor_1ad6d44a5d5d0a05) }

var fileDescriptor_1ad6d44a5d5d0a05 = []byte{
	// 510 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) EpochInfos(ctx context.Context, in *QueryEpochsInfoRequest, opts ...grpc.CallOption) (*QueryEpochsInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fachain.epochs.Query/EpochInfos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CurrentEpoch(ctx context.Context, in *QueryCurrentEpochRequest, opts ...grpc.CallOption) (*QueryCurrentEpochResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fachain.epochs.Query/CurrentEpoch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) EpochInfo(ctx context.Context, in *QueryEpochInfoRequest, opts ...grpc.CallOption) (*QueryEpochInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fachain.epochs.Query/EpochInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EpochInfos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fachain.epochs.Query/EpochInfos",
	}
...
func _Query_CurrentEpoch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fachain.epochs.Query/CurrentEpoch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_EpochInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fachain.epochs.Query/EpochInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fachain.epochs.Query",
	...
	Metadata: "fachain/epochs/query.proto",
}
